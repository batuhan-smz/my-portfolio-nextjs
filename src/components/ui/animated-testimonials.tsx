        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              <a href={testimonials[active].link} // Örneğin: https://instagram.com/kullaniciadi
                target="_blank" // Yeni sekmede açmak için
                rel="noopener noreferrer" // Güvenlik için
                className="inline-flex items-center hover:underline transition-colors duration-200" // <<< Değişiklik burada
              >
                <Instagram className="h-4 w-4 mr-1.5" /> {/* <<< İkon boyutu ve sağ boşluk */}
